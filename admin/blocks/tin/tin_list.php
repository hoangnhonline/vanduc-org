...
$offset = $limit * ($page - 1);
$listsp = $t->Tin_List($idLT,$tukhoa,$limit,$offset);
$page_show=5;
?>
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('.anhien').click(function(){
			...
			var idTin = $(this).attr('idTL');	
			if(src=='images/icons/hien.png'){
				$(this).attr('src','images/icons/an.png');
				
				$.post(
					'ajax_anhien.php',
					{idTin:idTin,AnHien:0},
					function(){}
				);				
			}
			else {
				$(this).attr('src','images/icons/hien.png');
				$.post('ajax_anhien.php',{idTin:idTin,AnHien:1},function(){});
			}
		});	
	});
</script>
