       	...
       	<legend>Thông tin chính</legend>
           	  <table>
                  ...
                  <tr class="left">
                      ...
                      <td><input type="text" name="TenDN" id="TenDN" class="tf" value="" />
                  ...
                  <tr>
                      ...
                      <td>
                        <input type="text" name="KinhDo" id="KinhDo" class="tf" value=""/>
                    </td>                        
                  </tr>
                  <tr>
               	    <td class="left">Vĩ độ ( Lat )</td>
                      <td>
                        <input type="text" name="ViDo" id="ViDo" class="tf" value=""/>
                    </td>                         
                </tr>
              </table>
        	...
        	<legend>Thông tin chi tiết</legend>
            	<table>
                    ...
                    <tr class="left">
                        ...
                        <textarea class="meta" name="ThongTin" id="ThongTin"  ></textarea>
