<?php 
$idPT = $_GET[idPT];settype($idPT,"int");
$chitiet = $pt->PhuongThuc_ChiTiet($idPT);
$row= mysql_fetch_assoc($chitiet);
if(isset($_POST[btnSumit])){
	$thanhcong = $pt->PhuongThuc_Edit($idPT,$loi);	
	if($thanhcong==true){
		header("location:index.php?com=pt_list");
	}
}
?>
...
<div id="admin_navigation">
	<div style="float:left;width:90%">
		<h3>Quản lý phương thức : cập nhật</h3>
    </div>
        	...
        	<legend>Thông tin chi tiết</legend>
            	<table>
                    ...
                    <tr class="left">
                        ...
                        <td><input type="text" name="TenPT" id="TenPT" class="tf" value="<?php echo $row[TenPT];?>" />
