...
<div id="admin_navigation">
	<div style="float:left;width:90%">
		<h3>Quản lý chuyên mục : Thêm mới</h3>
    </div>
        	...
        	<legend>Thông tin chi tiết</legend>
            	<table>                	              
                    <tr class="left">
                        ...
                        <td><input type="text" name="TenLT" id="TenLT" class="tf" />
                        	<span class="error"><?php echo $loi[TenLT];?></span>
                        </td>                        
                    </tr>
                    <tr class="left">
                    	<td>Tên chuyên mục KD</td>
                        <td><input type="text" name="TenLT_KD" id="TenLT_KD" class="tf"/></td>                        
                    </tr>                    
